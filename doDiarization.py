...
# FILES_FOR_LEARNING_GLOBAL_PATH = "C:\SeongPill/Developer/Untouchuble/diarization/datas/*.wav"
FILES_FOR_LEARNING_GLOBAL_PATH = "C:\SeongPill/Developer/Untouchuble/diarization/predict/ts_003.wav"
...
def Init() :
    training_se, training_cl =  d.dataPreprocessing(FILES_FOR_LEARNING_GLOBAL_PATH)
    m, ma, ta, ia = d.modelInitialization()
    d.modelFitSave(m, training_se, training_cl, ta)
